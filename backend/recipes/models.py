...
class ShoppingList(models.Model):
    ...
    user = models.ForeignKey(
        ...
        on_delete=models.CASCADE,
        verbose_name='Пользователь',
        related_name='shoping_user',
    )
    recipe = models.ForeignKey(
        Recipe,
        on_delete=models.CASCADE,
        verbose_name='Рецепт',
        related_name='shoping_recipe'
    )
...
class ListOfIngredients(models.Model):
    """Модель для получения ингредиентов из рецепта."""
...
class ListOfTags(models.Model):
    """Модель для создания тегов в рецептах."""
